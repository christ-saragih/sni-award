...
class LeadEvaluatorTimController extends Controller
{
    public function index($registrasi_id) {
        ...
        if ($registrasi) {
            ...
            return view('lead_evaluator.tim.index', [
    ...
    public function create($registrasi_id) {
        ...
        if ($registrasi) {
            ...
            if (!$tim) {
                ...
                return view('lead_evaluator.tim.create', [
                    'registrasi' => $registrasi,
                    'evaluator' => $evaluator,
                    'lead_evaluator' => $lead_evaluator,
                ]);
            }
            return redirect()->route('lead_evaluator.tim.view', $undecrypted_id)->withErrors("tim penilai telah dibentuk");
        }
        return view('guest.404.404');
    }
    ...
    public function store(Request $request, $registrasi_id) {
        ...
        if ($registrasi && $registrasi->sekretariat_id == Auth::user()->id) {
            ...
            if (!$tim) {
                ...
                return redirect()->route('lead_evaluator.tim.view', $undecrypted_id)->with('success', 'Berhasil membentuk tim');
            }
