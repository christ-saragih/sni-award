...
class RiwayatPesertaController extends Controller
{
    ...
    public function detail(string $id) {
        ...
        return view('peserta.riwayat.detail', compact(['registrasi','desk_evaluation', 'site_evaluation', 'assessment_kategori', 'data_assessment_kategori', 'registrasi_assessment', 'registrasi_dokumen', 'dokumen']));
    }
}
