                  ...
                  <div class="card" style="border-radius: 15px;">
                    <div class="card-body">
                      ...
                      <div class="row align-items-center pb-3">
                          ...
                          <div class="col-md-8 pe-5">
                            <div class="data">{{ $user->user_profil->npwp }}</div>
                          </div>
                      </div>
                      ...
                      <div class="row align-items-center pb-3">
                          ...
                          <div class="col-md-8 pe-5">
                            <div class="data">{{ $user->user_profil->no_rekening }}</div>
                          </div>
                      </div>
                      ...
                      <div class="row align-items-center pb-3">
                        ...
                        <div class="col-md-8 pe-5">
                            <div class="data"><a href="{{ $user->user_profil->url_cv }}" target="_blank">{{ $user->user_profil->url_cv }}</a></div>
                        </div>
                      </div>
                      ...
                      <div class="row align-items-center pb-3 mb-5">
                          ...
                          <div class="col-md-8 pe-5">
                            <div class="data"><a href="{{ $user->user_profil->url_anti_penyuapan }}" target="_blank">{{ $user->user_profil->url_anti_penyuapan }}</a></div>
                          </div>
                      </div>
