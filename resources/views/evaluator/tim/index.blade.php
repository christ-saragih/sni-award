    ...
    <div class="tab-pane">
        <div class="content-profil py-5 mb-5">
            ...
            <div class="d-flex justify-content-end mt-4">
                @if (!$tim)
                    <a href="{{ route('evaluator.tim.create', Crypt::encryptString($registrasi->id)) }}" class="btn px-3" style="background-color: #E59B30; color: white; font-weight: bold; border-radius: 15px;">Buat Tim</a>
                @endif
            </div>
