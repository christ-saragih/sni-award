<form  method="POST" action="/peserta/profil" id="simple-tabpanel-1" role="tabpanel" aria-labelledby="simple-tab-1"> 
                ...
                <div class="card" style="border-radius: 15px;">
                    <div class="card-body" style="display:;">
                        ...
                        <div class="row align-items-center pt-4 pb-3">
                            ...
                            <input type="text" name="nama_penghubung" class="form-control form-control-lg" />
                            </div>
                        </div>
