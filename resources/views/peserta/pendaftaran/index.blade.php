...
<ul class="nav nav-tabs d-flex gap-2 text-center" id="tabs-profil" role="tablist">
    ...
    <li class="nav-item" role="presentation">
        <a class="nav-link {{ request()->query('tab') == 'assessment' ? 'active' : ''}}" id="simple-tab-1" href="/peserta/pendaftaran?tab=assessment" role="tab">Assessment</a>
    </li>
    <li class="nav-item" role="presentation">
        <a class="nav-link {{ request()->query('tab') == 'dokumen' ? 'active' : ''}}" id="simple-tab-2" href="/peserta/pendaftaran?tab=dokumen" role="tab">Dokumen</a>
    </li>
</ul>
<hr class="p-0">
