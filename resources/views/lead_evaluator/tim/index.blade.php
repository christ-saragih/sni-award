            ...
            <div class="content-profil py-5 mb-5">
                <div>
                    <div class="d-flex align-items-center gap-2 mb-1">
                        <h3 class="mb-0 pb-0" style="font-size: 150%; font-size: 24px; font-weight: bold; color: #000000;">Tim Penilai {{ $registrasi->peserta->nama }}</h3>
                ...
                <div class="d-flex justify-content-end mt-4">
                    @if (!$tim)
                        <a href="{{ route('lead_evaluator.tim.create', Crypt::encryptString($registrasi->id)) }}" class="btn px-3" style="background-color: #E59B30; color: white; font-weight: bold; border-radius: 15px;">Buat Tim</a>
                    @endif
                </div>

                <div class="container my-5">
                    <div class="d-flex justify-content-between">
                        <div class="d-flex flex-column align-items-center justify-content-center py-3" style="width: 30%; border: 1px solid #F7C35F; border-radius: 20px; box-shadow: 0px 4px 4px 0px rgba(159,175,191,0.9); color: black; text-decoration: none;">
                            ...
                            <p style="font-size: 18px; margin: 0px;">{{ $registrasi->sekretariat->name }}</p>
                        </div>
