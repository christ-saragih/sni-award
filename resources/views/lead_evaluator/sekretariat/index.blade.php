...
@section('content')
    ...
    <main>
        <ul class="nav nav-tabs d-flex gap-2 text-center" id="tabs-profil" role="tablist">
            ...
            <a class="nav-link text-center active" id="simple-tab-0" href="" role="tab" style="white-space: nowrap; width: fit-content;">Penilaian Peserta</a>
            </li>
        </ul>
        <hr class="p-0">
        <div class="tab-content" id="tab-content">

            <div class="tab-pane active" role="tabpanel" id="sekre-desk" aria-labelledby="sekre-desk">
                    ...
                    <div class="d-flex align-items-center gap-2 justify-content-end">
                        <div class="dropdown container-dropdown-internal">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                @foreach ($stage as $st)
                                    <li><a class="dropdown-item" href="{{ route('lead_evaluator.sekretariat.view', [
                                        'stage' => $st->id,
