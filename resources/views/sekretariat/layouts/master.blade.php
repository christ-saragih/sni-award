...
<aside
    ...
    >
      ...
      <div class="sidebar collapse navbar-collapse w-auto" id="sidebar">
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link {{ request()->is('sekretariat/sekretariat*') ? 'active' : '' }}" id="navLink" href="{{ route('sekretariat.peserta.view') }}">
              <div
          ...
          <!-- searching -->
            ...
            <ul class="navbar-nav d-flex ms-auto justify-content-end">
              <li class="nav-item dropdown px-2 d-flex align-items-center">
                ...
                <ul
                  class="dropdown-menu dropdown-menu-end px-2 py-3 me-sm-n4 border-0"
    ...
    <script src="{{ asset('assets') }}/peserta/js/app.js"></script>
