...
<article id="news">
    <div class="artikel-container">
        ...
        @if ($berita_terbaru)
        <div class="berita-terkini-container d-flex justify-content-between">
    ...
    <div class="semua-berita-container d-flex justify-content-between flex-wrap">
        ...
        @endforeach
        {{-- <div class="berita-containecol-lg-4 col-md-6 col-sm-12 rounded-3 p-0">
