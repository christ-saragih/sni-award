    ...
    >
      ...
      <div class="sidebar collapse navbar-collapse w-auto" id="sidebar">
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link {{ request()->is('admin/edit_front_page') ? 'active' : '' }}" id="navLink" href="/admin/edit_front_page">
              <div
                class="icon-shape icon-sm text-center me-1 d-flex align-items-center justify-content-center"
              >
      ...
      >
        <div class="container-fluid py-1 px-3">
          <nav aria-label="breadcrumb" class="d-flex ps-2 align-items-center gap-3">
            <i class="fa fa-bars" id="barsMenu" style="cursor: pointer; font-size: 20px;"></i>
            <h6 class="mb-0" style="font-size: 24px; font-weight: 600;">Beranda</h6>
