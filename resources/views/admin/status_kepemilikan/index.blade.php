...
<ul class="nav nav-tabs d-flex gap-2 text-center" id="tabs-profil" role="tablist">
    <li class="nav-item" role="presentation">
        <a class="nav-link active" id="status_kepemilikan" data-bs-toggle="tab" href="#status_kepemilikan_form" role="tab" aria-controls="status_kepemilikan_form" aria-selected="true" style="width: 100%;">Status Kepemilikan</a>
    </li>
</ul>
<hr class="p-0">
